...
class TestRunnerClustering:
    ...
    def test_assigns_cluster_ids_via_trace(self):
        ...
        pr = _photo_result("aaa", [FaceBox(x=0.1, y=0.1, w=0.3, h=0.3)], [trace])
        cluster(_gather_traces([pr]))
    ...
    def test_groups_similar_embeddings(self):
        ...
        pr1 = _photo_result("aaa", [FaceBox(x=0.1, y=0.1, w=0.2, h=0.2)], [t1])
        pr2 = _photo_result("bbb", [FaceBox(x=0.1, y=0.1, w=0.2, h=0.2)], [t2])
    ...
    def test_no_embedding_skipped(self):
        ...
        pr = _photo_result("aaa", [FaceBox(x=0.1, y=0.1, w=0.2, h=0.2)], [trace])
        cluster(_gather_traces([pr]))
